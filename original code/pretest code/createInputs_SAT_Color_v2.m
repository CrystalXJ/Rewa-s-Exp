...
%
% Create input file for a subject with night blocks 
% 
% -------------- Example --------------------
% inputs = createInputs_SAT_Color_v2('CCT',1)
% subID   = subject's ID, it should be a string
% pretest = whether this session is pretest session or not.
%  1 : if it's pretest session
%  0 : it's SAT session
...
%% Seperate per-test, practice and test session
